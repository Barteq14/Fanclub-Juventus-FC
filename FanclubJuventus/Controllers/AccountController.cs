        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //UserManager.AddToRole("u","User");
                    
                    FanclubContext db = new FanclubContext();
                    db.Profiles.Add(profile);
                    db.SaveChanges();
                    //SendMail(model.Email,"Rejestracja","Rejestracja przeprowadzona pomyślnie, możesz się zalogować");
